...
- the installed HyperFrames skill/docs in your agent environment, if available
...
- avoid wasting the safe zone on oversized padding, disconnected modules, or weak filler geometry; if a panel feels template-like or under-occupied, rebalance it before shipping
