...
def creative_direction_for_run(topic: str, script: str) -> Dict[str, object]:
    ...
    palettes = [
        {"palette_mode": "newsprint-contrast", "palette_note": "warm paper, charcoal text, restrained red alerts"},
        ...
        {"palette_mode": "briefing-ledger", "palette_note": "slate base, sharp source cards, financial briefing tone"},
    ]
    typography = [
...
def build_master_prompt(topic: str, script: str) -> str:
    ...
    return (
        "Plan a square 1:1 HyperFrames visual package for the top half of a vertical short-form trending-news character video. "
        f"Topic: {topic}. "
        "The top half should feel like premium editorial motion design: clean typography, strong visual hierarchy, source cards, timeline boards, data cards, and information graphics when useful. "
