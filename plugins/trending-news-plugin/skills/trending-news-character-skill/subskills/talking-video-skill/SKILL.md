...
description: Render a HeyGen talking-head clip from the approved script, assemble it with a separately generated HyperFrames top-half visual, then speed up the final assembled 9:16 master with FFmpeg.
---
